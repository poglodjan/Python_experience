...
def validate(n, d, dlugosc_listy):
    if not type(n) == int:
        print('prowadzone dane są błędne, spróbuj jeszcze raz')
        main()
    if not type(d) == int:
        print('Wprowadzone dane są błędne, spróbuj jeszcze raz')
        main()
    if n < d:
        print('Wprowadzone dane są błędne, spróbuj jeszcze raz')
        main()
...
def main():
    d = int(input('wprowadż daną odległość:'))  # odległość
    n = int(input('wprowadż długość mapy:'))  # długość mapy
    plik = input('wczytaj plik:')  # plik
