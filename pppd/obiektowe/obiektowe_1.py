...
class Zespolona:
    ...
    def __eq__(self, other):
        # zakładam że other jest typu Zespolona
        # porównuję tak, żeby działało dla floatów, stąd nie ma == tylko sprawdzam czy różnica jest mała
        # if abs(self.re - other.re) < 1e-7 and abs(self.im - other.im) < 1e-7:
        #     return True
        # else:
        #     return False
